...
import {fetchAccountBalancesJson, fetchATransactionJson, fetchTransactionsJson} from './api/EstateAPIManager.js'
                    ...
                    const accountTransactionsRows = transactionsJson.transactions.map(transaction => {
                        return <tr>
                            ...
                            <td style={{
                                ...
                                textAlign: "Left",
                                fontSize: '.8rem'
                            }}>{transaction.particular}</td>
                            <td style={{
                                whiteSpace: 'nowrap',
                                textAlign: "right",
                                fontSize: '.8rem'
                            }}>{NumberFormatNoDecimal(transaction.debit)}</td>
                            <td style={{
                                whiteSpace: 'nowrap',
                                textAlign: "right",
                                fontSize: '.8rem'
                            }}>{NumberFormatNoDecimal(transaction.credit)}</td>
                        </tr>
                    });
    ...
    render() {
        ...
        for (const [head, accountsBalance] of Object.entries(headAccountBalances)) {
            accountsBalanceRows.push(<tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}>
                <td id={head}
                    style={{textAlign: "left", fontSize: '.8rem', whiteSpace: 'wrap', fontWeight: 'bold'}}>{head}</td>
                ...
                <td id={head} style={{
                    ...
                    whiteSpace: 'wrap',
                    fontWeight: 'bold'
                }}>{NumberFormatNoCurrency(balanceByHeadDebit[head])}</td>
                <td id={head} style={{
                    textAlign: "right",
                    fontSize: '.8rem',
                    whiteSpace: 'wrap',
                    fontWeight: 'bold'
                }}>{NumberFormatNoCurrency(balanceByHeadCredit[head])}</td>
            </tr>);
            accountsBalance.map(record => {
                if (record.balance < 0) {
                    accountsBalanceRows.push(<tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}
                        ...
                        <td id={record.account}
                            style={{textAlign: "left", fontSize: '.8rem', whiteSpace: 'wrap'}}>{record.account}</td>
                        <td id={record.account} style={{
                            textAlign: "right",
                            fontSize: '.8rem',
                            whiteSpace: 'wrap'
                        }}>{NumberFormatNoCurrency(Math.abs(record.balance))}</td>
                        <td id={record.account} style={{
                            textAlign: "right",
                            fontSize: '.8rem',
                            whiteSpace: 'wrap'
                        }}>{NumberFormatNoCurrency(0)}</td>
                    </tr>);
                } else {
                    accountsBalanceRows.push(<tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}
                                                 onClick={this.showModal}>
                        ...
                        <td id={record.account} style={{
                            ...
                            fontSize: '.8rem',
                            whiteSpace: 'wrap'
                        }}>{NumberFormatNoCurrency(record.balance)}</td>
                    </tr>);
                }
            });
        }
        ...
        const monthTransactionsRows = months.map(month => {
            return <tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}>
                <td style={{
                    ...
                    textAlign: "Center",
                    fontSize: '.8rem'
                }}>{format(parseISO(month), 'MMM yyyy')}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.SAVING[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.SBI_MAX_GAIN[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.BOB_ADVANTAGE[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.ADARSH[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.MISC_ADARSH[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.INTEREST_ADARSH[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.ODION[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.MISC[month])}</td>
                <td style={{
                    whiteSpace: 'nowrap',
                    textAlign: "Right",
                    fontSize: '.8rem'
                }}>{NumberFormatNoDecimal(accountMonthTransaction.INTEREST[month])}</td>
            </tr>
        });
        ...
        const monthlyMaxGainRows = monthlyMaxGains.map(record => {
            return <tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}>
                <td style={{
                    ...
                    textAlign: "Center",
                    fontSize: '.8rem'
                }}>{format(parseISO(record.month), 'MMM yyyy')}</td>
                <td style={{
                    textAlign: "right",
                    fontSize: '.8rem',
                    whiteSpace: 'wrap'
                }}>{NumberFormatNoDecimal(record.amount)}</td>
            </tr>
        });
        ...
        yearlySavings.forEach((amount, year) => {
            yearlySavingRows.push(<tr style={{textAlign: "center", fontSize: '1rem', whiteSpace: 'wrap'}}>
                ...
                <td style={{
                    ...
                    fontSize: '.8rem',
                    whiteSpace: 'wrap'
                }}>{NumberFormatNoDecimal(amount)}</td>
            </tr>)
        });
                ...
                <Row>
                    <Col m={6} s={6} l={6}>
                        <Card className="teal lighten-4" textClassName="black-text" title="Account Statement">
                            <div>
                                ...
                                <Modal isOpen={transactionModalShow} onClose={this.hideModal}
                                       contentLabel="AccountTransactions" modalClassName="custom-modal-style">
                    ...
                    <Col m={6} s={6} l={6}>
                        <Card className="teal lighten-4" textClassName="black-text" title="Funding by Source">
                            <div>
                                <DrawPiChart data={fundings} total={total + totalAdarsh + totalJyothi}
                                             divContainer="funding-source-pie-container"
                                             heads={['Saving', 'SBI Max Gain', 'BoB Advantage']}/>
                            </div>
                        </Card>
                    </Col>
                    <Col m={6} s={6} l={6}>
                        <Card className="teal lighten-4" textClassName="black-text" title="Funded in Property">
                            <div>
                                <DrawPiChart data={fundingsProperty} total={total + totalAdarsh + totalJyothi}
                                             divContainer="funding-property-pie-container"
                                             heads={['Odion', 'Adarsh', 'Jyothi']}/>
                            </div>
                        </Card>
                    </Col>
                    <Col m={6} s={6} l={6}>
                        <Card className="teal lighten-4" textClassName="black-text" title="Loans">
                            <div>
                                <DrawPiChart data={loans} total={loanTotal} divContainer="loans-pie-container"
                                             heads={['SBI Max Gain', 'BoB Advantage', 'LIC HFL', 'HDFC HFL']}/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                                ...
                                <Table striped bordered hover size="sm">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3" width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightgrey"}}>Funding
                                        </th>
                                        <th colspan="3" width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightblue"}}>Adarsh
                                        </th>
                                        <th colspan="3" width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightpink"}}>Odion
                                        </th>
                                    </tr>
                                    <tr>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightgrey"}}>Saving
                                        </th>
                                        <th width="10%" style={{textAlign: "center", backgroundColor: "lightgrey"}}>SBI
                                            MG
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightgrey"}}>BoB
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightblue"}}>Adarsh
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightblue"}}>Misc
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightblue"}}>Interest
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightpink"}}>Odion
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightpink"}}>Misc
                                        </th>
                                        <th width="10%"
                                            style={{textAlign: "center", backgroundColor: "lightpink"}}>Interest
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                ...
                <Row>
                    <Col m={6} s={6} l={6}>
                        <Card className="teal lighten-4" textClassName="black-text"
                              title="Max Gain Monthly Transactions">
                            <div>
                                <Table striped bordered hover size="sm">
                                    <thead>
                                    <tr>
