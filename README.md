...
This project was bootstrapped with [reactstrap](https://reactstrap.github.io/).
...
1. Build
````
docker build -t alokkusingh/home-dashboard:latest -t alokkusingh/home-dashboard:1.3.0 .
````
2. Push
````
...
````
````
docker push alokkusingh/home-dashboard:1.3.0
````
2. Deploy
````
